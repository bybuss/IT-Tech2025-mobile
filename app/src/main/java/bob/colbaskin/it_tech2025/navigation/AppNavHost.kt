...
import bob.colbaskin.it_tech2025.common.design_system.CustomSnackbarHost
...
import bob.colbaskin.it_tech2025.navigation.graphs.mainGraph
import bob.colbaskin.it_tech2025.navigation.graphs.onboardingGraph
...
fun AppNavHost(uiState: UiState.Success<UserPreferences>) {
    ...
    Scaffold(
        ...
        NavHost(
            startDestination = Graphs.Main, // getStartDestination(uiState.data.authStatus),
